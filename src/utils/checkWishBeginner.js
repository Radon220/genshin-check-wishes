...
const checkWishBeginner = async (authCode,callback)=>{
    var bannerArray = []
    var checking = true
    var page = 1 
    ...
    while(checking){
        if(page === 1){
            ...
            if(tempArray.length > 1){
                bannerArray = bannerArray.push(tempArray)
            }
            else{
                checking = false;
...
module.exports = checkWishBeginner
